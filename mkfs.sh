...
{	
    ...
    # only copied in ar6302 sdio wifi application
	cp $DRV_DIR/ar6000.ko $PRODUCT_ROOT/drv
	cp -rf $DRV_DIR/ath6k $PRODUCT_ROOT/drv 
    # only copied in usi4329 sdio wifi application
	cp $DRV_DIR/usi4329_dhd.ko $PRODUCT_ROOT/drv
	cp $DRV_DIR/usi4329_fw.bin $PRODUCT_ROOT/drv
	cp $DRV_DIR/usi4329_nvram.txt $PRODUCT_ROOT/drv
